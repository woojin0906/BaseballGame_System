...
public class SignUp extends JFrame implements ActionListener, MouseListener{
	...
	private void SignUpPannel() {
		...
		SignUp_PW.setBounds(90, 140, 100, 30);
		...
		SignUp_PW_Check.setBounds(90, 190, 100, 30);
		...
		SignUp_Nickname.setBounds(90, 240, 100, 30);
		...
		SignUp_textfield_id.setBounds(210, 90, 200, 25);
		...
		SignUp_textfield_Email.setBounds(210, 290, 200, 25);
...
//		//2022-10-23 뒷 배경 이미지 
//		ImageIcon signUpimg = new ImageIcon("images/signUpImg.jpg");
//		JLabel lblsignup = new JLabel(signUpimg);
//		lblsignup.setBounds(0, -20, 600, 500);
//		SignUp_Pannel.add(lblsignup);
		add(SignUp_Pannel);
